...
def raw_analysis(file_bin, analysed_parts, sign_min_size, test_dir, subdiv, sleep, replacing_value=0):
    ...
    if len(new_range_list) == 0:
        ...
        return raw_analysis(file_bin, new_range_list, sign_min_size, subdiv, sleep)
